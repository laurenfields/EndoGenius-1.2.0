...
def make_a_DB(variable_mod_dict,fasta_path,output_folder,max_mods_number):
    ...
    def monoisotopic_mass_calculator(peptide_from_fasta):
        ...
        # print('PTM mass change: ', check_PTM(peptide_from_fasta))
        # print('C-term mass change: ', check_c_term(peptide_from_fasta))
        # print('N-term mass change: ', check_n_term(peptide_from_fasta))
        ...
        # print('calculated mass to charge: ', mass_to_charge)
        # print('\n\n\n')
